...
const AuthHeader = ({seeCar = false}) => {
    ...
    useEffect(() => {
        if (location.pathname === '/profile' 
            ...
            || location.pathname === "/profile/edit-address"
            || location.pathname === "/profile/new-address") {
    ...
    return (
        <div className="AuthHeader">
            ...
            <div className="aucont">
                ...
                <div className={`circleProfile ${hasBackground ? 'hasBackground' : ''}`}>
                    <img src={Perfil} alt="Perfil" className={`iconp ${hasBackground && "changecolor-r"}`}/>
                </div>
            </div>
